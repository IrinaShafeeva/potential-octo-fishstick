...
Что уже описано в этой главе (краткое содержание главы):
{thread_summary}
...
— не повторять факты и детали, уже описанные в этой главе
Не вплетай в текст события из контекста главы — каждое воспоминание самостоятельное.
