...
- Возвращай {"is_complete": true} ТОЛЬКО если история развёрнутая: есть время/год, место, люди, что произошло. Одно-два предложения — это никогда не полная история, обязательно задай вопрос.
