...
1. Незакрытые имена — упомянула человека вскользь, не объяснила кто он
2. Место и атмосфера — как выглядело, пахло, звучало
3. Временной провал — пропущен кусок между событиями
4. Эмоции которые не названы — "как ты себя чувствовала в тот момент?"
5. Действие которое осталось за кадром — "а что ты сделала после?"
